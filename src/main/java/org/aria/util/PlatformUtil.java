...
public class PlatformUtil {
	...
	static {
		...
		if (useEGL) {
			doEGLCompositing = AccessController
					.doPrivileged((PrivilegedAction<Boolean>) () -> Boolean.getBoolean("doNativeComposite"));
		} else
	...
	/**
	 * Utility method used to determine whether the version number as reported by
	 * system properties is greater than or equal to a given value.
	 *
	 * @param value
	 *            The value to test against.
	 * @return false if the version number cannot be parsed as a float, otherwise
	...
	/**
	 * Returns the directory containing the JavaFX runtime, or null if the directory
	 * cannot be located
	 */
